...
* [make-README.sh](https://github.com/JeffDeCola/my-cheat-sheets/blob/master/other/stem/math/pure/number-systems/natural-numbers-cheat-sheet/make-README.sh)
  uses
