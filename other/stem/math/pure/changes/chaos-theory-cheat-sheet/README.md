...
* [make-README.sh](https://github.com/JeffDeCola/my-cheat-sheets/blob/master/other/stem/math/pure/changes/chaos-theory-cheat-sheet/make-README.sh)
  uses
