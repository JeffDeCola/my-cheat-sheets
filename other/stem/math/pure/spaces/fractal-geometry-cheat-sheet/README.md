...
* [make-README.sh](https://github.com/JeffDeCola/my-cheat-sheets/blob/master/other/stem/math/pure/spaces/fractal-geometry-cheat-sheet/make-README.sh)
  uses
